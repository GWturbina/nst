    ...
    <div className="fixed inset-0 bg-black/85 z-50 flex items-center justify-center p-3" onClick={onClose}>
      <div className="w-full max-w-md max-h-[85vh] rounded-2xl overflow-hidden flex flex-col"
        ...
        <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 text-[12px] text-slate-300 leading-relaxed">
          ...
          {tab === 'showcase' && (<>
            <HelpTitle emoji="🏪" text="Витрина" />
            <p>Витрина — это маркетплейс для продажи реальных драгоценностей: камней, ювелирных изделий, металлов. Продажа происходит при участии сертифицированного агента.</p>

            <HelpTitle emoji="🪪" text="Как стать агентом" />
            <p>Для публикации объявлений нужна лицензия агента. Купите её в разделе «Витрина». Агенты проверяют товары и подтверждают сделки.</p>

            <HelpTitle emoji="📝" text="Как продать через витрину" />
            <HelpSteps steps={[
              'Получите лицензию агента',
              'Нажмите «+ Разместить»',
              'Укажите тип, название, описание, фото, сертификат и цену',
              'Когда найдётся покупатель — подтвердите продажу',
            ]} />
          </>)}
          ...
          {tab === 'dct' && (<>
            ...
            <p>DCT (Diamond Club Token) — токен, обеспеченный реальными бриллиантами. Его цена привязана к стоимости камней в хранилище клуба. Это не спекулятивный токен — за каждым DCT стоит реальный актив.</p>

            <HelpTitle emoji="💎" text="Как получить DCT" />
            <HelpSteps steps={[
              'Закажите камень в разделе «Камни»',
              'Когда камень будет подтверждён — перейдите в раздел «DCT»',
              'Нажмите «Получить DCT»',
              'Токены поступят на ваш баланс',
            ]} />
            <p className="text-[10px] text-slate-500">Часть токенов будет заморожена — они привязаны к камню и разблокируются при его продаже.</p>

            <HelpTitle emoji="🧩" text="Доли камней" />
            <p>Не обязательно покупать целый камень. Можно купить долю дорогого камня за DCT. Все держатели долей получают стейкинг-доход в USDT пропорционально своей доле.</p>

            <HelpTitle emoji="🔄" text="Биржа DCT" />
            <p>Встроенная биржа позволяет покупать и продавать DCT за USDT. Создайте ордер с ценой и количеством — когда другой участник заполнит его, сделка совершится автоматически.</p>
          </>)}

          {tab === 'heritage' && (<>
            <HelpTitle emoji="📜" text="Наследование" />
            <p>Система наследования защищает ваши активы на случай если вы не сможете управлять ими. Вы назначаете наследников — и если вы не появляетесь определённое время, они получат ваши DCT и доли камней автоматически.</p>

            <HelpTitle emoji="⚙️" text="Как настроить" />
            <HelpSteps steps={[
              'Перейдите в раздел «Наследство»',
              'Одобрите доступ к DCT и долям (кнопки «Одобрить»)',
              'Нажмите «Настроить»',
              'Укажите от 1 до 5 наследников: имя, адрес кошелька, % доли',
              'Сумма долей должна быть ровно 100%',
              'Укажите период неактивности (минимум 365 дней)',
              'Сохраните и подтвердите в кошельке',
            ]} />

            <HelpTitle emoji="🔔" text="Подтверждение активности" />
            <p>Регулярно нажимайте кнопку «Я здесь» — это сбрасывает таймер. Если не нажимать дольше установленного периода — наследники смогут забрать активы.</p>

            <HelpTitle emoji="⚠️" text="Важно" />
            <p>Наследование работает полностью на блокчейне — ни клуб, ни администрация не могут вмешаться. Только вы и ваши наследники контролируют этот процесс.</p>
          </>)}
        </div>
      ...
      <div className="p-3 rounded-2xl glass">
        ...
        <div className="mt-3 text-[9px] text-slate-500">
          <div className="grid grid-cols-3 gap-1">
            ...
            <div className="p-1.5 rounded bg-white/5 text-center"><b className="text-white">30K DCT</b><br/>60%</div>
            <div className="p-1.5 rounded bg-white/5 text-center"><b className="text-white">50K DCT</b><br/>65%</div>
            <div className="p-1.5 rounded bg-white/5 text-center"><b className="text-white">80K DCT</b><br/>70%</div>
            <div className="p-1.5 rounded bg-white/5 text-center"><b className="text-gold-400">100K DCT</b><br/>75%</div>
          </div>
        </div>
      </div>
    </div>
