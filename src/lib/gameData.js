...
// КЛЮЧЕВАЯ ЭКОНОМИКА:
// ────────────────────
// Цель: за 1 год ежедневной игры натапать ~16,000 NSS (Lv.6-7)
// Энергия: 200, восстановление 1/120сек (полная зарядка ~6.7 часов)
// Реалистично: ~2 полных цикла в день = ~400 тапов/день
//
// Уровень 0  (Руки):     0.01 NSS/tap × 400 =   4/день →  1,460/год
// Уровень 4  (Авто):     0.12 NSS/tap × 400 =  48/день → 17,520/год
// Уровень 8  (Эксперт):  0.28 NSS/tap × 400 = 112/день → 40,880/год
// Уровень 12 (Империя):  0.40 NSS/tap × 400 = 160/день → 58,400/год
//
